...
//    MARK: - Interface methods
    ...
    public static func resize(image: UIImage, toSize size: CGSize,
                              completion: @escaping ResizerCompletion) {
        resize(image: image, contentMode: .scaleToFill, toSize: size, interpolationQuality: .default,
    ...
    public static func resize(image: UIImage, contentMode: UIViewContentMode, toSize size: CGSize,
        ...
        DispatchQueue.global(qos: .background).async {
            self.resizeImageFromImage(image, toSize: scaleDependentNewSize, newBounds: newBounds,
                                      interpolationQuality: quality, completion: completion)
        }
    }
...
//    MARK: - Private methods
    ...
    private static func imageFrom(image: UIImage,
                                  toSize size: CGSize,
